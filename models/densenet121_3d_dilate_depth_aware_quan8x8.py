...
def build(conf, phase='train'):
    ...
    src_weights = torch.load('/media/hdd/jhkim/git/M3D-RPN/M3D-RPN-Release/m3d_rpn_depth_aware_test')
    ...
    modules_to_replace = quan.find_modules_to_quantize(rpn_net, args_q.quan)
