...
conf_path = '/media/hdd/jhkim/git/M3D-RPN/output/kitti_3d_multi_main_resnet50/conf.pkl'
weights_path = '/media/hdd/jhkim/git/M3D-RPN/output/kitti_3d_multi_main_resnet50/weights/model_100000_pkl'
...
results_path = os.path.join('output', 'kitti_3d_multi_main_resnet50', 'results', 'results_100000', 'data')
results_save_path = os.path.join('output', 'kitti_3d_multi_main_resnet50', 'results')
