...
for i in range(len(test_list)):
    ...
    for j in range(len(model_weight_list)):
        ...
        results_path = 'results_' + str((j+1) * 10000)
        results_path = os.path.join('output', test_file, 'results', results_path, 'data')
        results_save_path = os.path.join('output', 'for_plot', test_file)
        ...
        test_kitti_3d_q_for_plot(conf.dataset_test, net, conf, results_path, data_path, results_save_path, use_log=False)